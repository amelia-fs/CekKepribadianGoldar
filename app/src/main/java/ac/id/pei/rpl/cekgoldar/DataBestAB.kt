...
class DataBestAB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_best_a_b)
        layoutku = findViewById(R.id.rv_databestab)
        fire = FirebaseDatabase.getInstance().getReference("GoldarAB").child("BesttraitsAB")
