...
class DataFoodB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_food_b)
        layoutku = findViewById(R.id.rv_datafoodb)
        fire = FirebaseDatabase.getInstance().getReference("GoldarB").child("Food")
