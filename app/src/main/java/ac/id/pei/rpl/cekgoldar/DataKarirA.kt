...
class DataKarirA : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_karir)
        layoutku = findViewById(R.id.rv_datakarira)
        fire = FirebaseDatabase.getInstance().getReference("GoldarA").child("Carrier")
