...
class DataKarirO : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_karir_o)
        layoutku = findViewById(R.id.rv_datakariro)
        fire = FirebaseDatabase.getInstance().getReference("CarrierO")
