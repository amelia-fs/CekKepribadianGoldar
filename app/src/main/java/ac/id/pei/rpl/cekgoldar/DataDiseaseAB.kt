...
class DataDiseaseAB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_disease_a_b)
        layoutku = findViewById(R.id.rv_datadiseaseab)
        fire = FirebaseDatabase.getInstance().getReference("GoldarAB").child("Disease")
