...
class DataRomanceA : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_romance)
        layoutku = findViewById(R.id.rv_dataromana)
        fire = FirebaseDatabase.getInstance().getReference("GoldarA").child("Romance")
