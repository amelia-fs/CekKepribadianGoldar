...
class DataRomanceB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_romance_b)
        layoutku = findViewById(R.id.rv_dataromanb)
        fire = FirebaseDatabase.getInstance().getReference("GoldarB").child("Romance")
