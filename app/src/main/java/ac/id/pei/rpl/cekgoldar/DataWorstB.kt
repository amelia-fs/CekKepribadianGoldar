...
class DataWorstB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_worst_b)
        layoutku = findViewById(R.id.rv_dataworstb)
        fire = FirebaseDatabase.getInstance().getReference("GoldarB").child("WorsttraitsB")
