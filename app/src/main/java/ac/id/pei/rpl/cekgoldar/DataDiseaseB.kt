...
class DataDiseaseB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_disease_b)
        layoutku = findViewById(R.id.rv_datadiseaseb)
        fire = FirebaseDatabase.getInstance().getReference("GoldarB").child("Disease")
