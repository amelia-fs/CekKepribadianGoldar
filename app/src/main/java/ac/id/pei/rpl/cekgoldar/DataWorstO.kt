...
class DataWorstO : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_worst_o)
        layoutku = findViewById(R.id.rv_dataworsto)
        fire = FirebaseDatabase.getInstance().getReference("WorstTraitsO")
