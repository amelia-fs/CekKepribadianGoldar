...
class DataWorstA : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_worst)
        layoutku = findViewById(R.id.rv_dataworsta)
        fire = FirebaseDatabase.getInstance().getReference("GoldarA").child("WorsttraitsA")
