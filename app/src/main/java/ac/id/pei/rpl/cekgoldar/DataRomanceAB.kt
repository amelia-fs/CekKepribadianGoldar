...
class DataRomanceAB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_romance_a_b)
        layoutku = findViewById(R.id.rv_dataromanab)
        fire = FirebaseDatabase.getInstance().getReference("GoldarAB").child("Romance")
    ...
    private fun loadMeNow(){
        ...
        val myA = FirebaseAdapterRomance(ambilDatabase)
