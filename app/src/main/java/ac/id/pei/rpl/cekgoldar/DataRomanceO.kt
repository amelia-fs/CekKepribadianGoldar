...
class DataRomanceO : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_romance_o)
        layoutku = findViewById(R.id.rv_dataromano)
        fire = FirebaseDatabase.getInstance().getReference("RomanceO")
