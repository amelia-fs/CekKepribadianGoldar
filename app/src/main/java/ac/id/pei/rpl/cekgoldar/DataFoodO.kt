...
class DataFoodO : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_food_o)
        layoutku = findViewById(R.id.rv_datafoodo)
        fire = FirebaseDatabase.getInstance().getReference("FoodO")
