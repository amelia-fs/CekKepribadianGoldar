...
class DataBestB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_best_b)
        layoutku = findViewById(R.id.rv_databestb)
        fire = FirebaseDatabase.getInstance().getReference("GoldarB").child("BesttraitsB")
