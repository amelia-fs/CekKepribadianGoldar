...
class DataBestA : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_best)
        layoutku = findViewById(R.id.rv_databesta)
        fire = FirebaseDatabase.getInstance().getReference("GoldarA").child("BesttraitsA")
