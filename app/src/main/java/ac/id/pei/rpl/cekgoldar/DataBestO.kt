...
class DataBestO : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_best_o)
        layoutku = findViewById(R.id.rv_databesto)
        fire = FirebaseDatabase.getInstance().getReference("BestTraitsO")
