...
class DataFoodAB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_food_a_b)
        layoutku = findViewById(R.id.rv_datafoodab)
        fire = FirebaseDatabase.getInstance().getReference("GoldarAB").child("Food")
    ...
    private fun loadMeNow(){
        ...
        val myA = FirebaseAdapterFood(ambilDatabase)
