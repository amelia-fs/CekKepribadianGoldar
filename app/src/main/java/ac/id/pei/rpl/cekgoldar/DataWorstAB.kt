...
class DataWorstAB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_worst_a_b)
        layoutku = findViewById(R.id.rv_dataworstab)
        fire = FirebaseDatabase.getInstance().getReference("GoldarAB").child("WorsttraitsAB")
    ...
    private fun loadMeNow(){
        ...
        val myA = FirebaseAdapterBestO(ambilDatabase)
