...
class DataKarirAB : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_karir_a_b)
        layoutku = findViewById(R.id.rv_datakarirab)
        fire = FirebaseDatabase.getInstance().getReference("GoldarAB").child("Carrier")
